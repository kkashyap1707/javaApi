...
public class Quickstart {
    ...
    private static final File DATA_STORE_DIR = new File(System.getProperty("user.dir"), "/sheet/.credentials/sheets.googleapis.com-java-quickstart");
    ...
    public static void AddLineSpreadSheet(String spreadsheetId, String[] line, Integer numberOfLine) throws Exception {
        ...
        Reporter.test.log(Status.INFO,"Line added successfully.");
    }
