...
public class DriveUtil extends TestBaseBrowser {
    ...
    public static String csvFilePath = System.getProperty("user.dir")+"/downloads/Corporate_1-good.csv";

    public static final String APPLICATION_NAME = "Google Drive API Java Quickstart";

    //public static final java.io.File DATA_STORE_DIR = new java.io.File(System.getProperty("user.home"), ".credentials/sheets.googleapis.com-java-quickstart");
    public static final File DATA_STORE_DIR = new File(System.getProperty("user.dir"), "/drive/.credentials/sheets.googleapis.com-java-quickstart");
    ...
    /*public static String uploadFilesToDrive() throws Exception{
        ...
        File filePath = new File("files/photo.jpg");
